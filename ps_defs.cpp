...
namespace ParticleSimulator{
    ...
    static const F32vec SHIFT_CENTER[N_CHILDREN] = 
        { F32vec(-0.5, -0.5), F32vec(-0.5, 0.5),
          F32vec( 0.5, -0.5), F32vec( 0.5, 0.5) };
#elif PARTICLE_SIMULATOR_ONE_DIMENSION
    typedef S32vec1 S32vec;
    typedef F32vec1 F32vec;
    typedef F64vec1 F64vec;
    static const S32 DIMENSION = 1;
#else
...
//    static const F64 LARGE_FLOAT = numeric_limits<F32>::max()*0.0625;
//    static const S64 LARGE_INT = numeric_limits<S32>::max()*0.0625;

...
public:
#ifdef SANITY_CHECK_REALLOCATABLE_ARRAY
	RellocatableArray() : data_(NULL), size_(0), capacity_(0), n_expand_(0) {}
	RellocatableArray(int cap) : size_(0), capacity_(cap), n_expand_(0) {
...
#else
	RellocatableArray() :
			data_(NULL), size_(0), capacity_(0), capacity_org_(0) {
	}
	RellocatableArray(int cap) :
			size_(0), capacity_(cap), capacity_org_(0) {
...
//		std::cout<<"des"<<std::endl;
	...
	RellocatableArray(RellocatableArray const &other) :
			data_(NULL) {
		data_ = new T[other.size_];
		size_ = other.size_;
		memcpy(data_, other.data_, sizeof(T) * size_);
		capacity_ = other.capacity_;
		capacity_org_ = other.capacity_org_;
	}
	RellocatableArray& operator=(const RellocatableArray& other) {
